...
/* ─── Realistic Mock Dataset for PT Taka Hydrocore Indonesia ─── */
const INITIAL_REGISTRATIONS: RegisteredDoc[] = [
  {
    ...
    dept: 'QHSE',
    jenis: 'Form / Standar',
    judul: 'Daily Safety Inspection & Offshore Hazard Observation Form',
    listDokumen: ['Customer', 'Seluruh Karyawan'],
    fileName: 'FRM-QHSSE-001_Hazard_Obs.pdf',
    fileSize: '420 KB',
    catatan: 'Formulir inspeksi harian untuk seluruh kru kapal THI Pacific Explorer.',
    status: 'Released',
  ...
  },
  {
    ...
    listDokumen: ['Seluruh Karyawan'],
    fileName: 'SOP-GEO-001_Soil_Investigation.pdf',
    fileSize: '1.2 MB',
    catatan: 'Revisi SOP pemboran laut dalam sesuai standar ISO 19901-8.',
    status: 'Released',
  ...
  },
  {
    ...
    jenis: 'Instruksi Kerja (Work Instruction)',
    judul: 'Heavy Winching, Anchor Handling & Vessel Deck Safety Protocol',
    listDokumen: ['Customer', 'Vendor / Kontraktor'],
    fileName: 'WI-OPS-002_Deck_Safety.pdf',
    fileSize: '890 KB',
    catatan: 'Prosedur keselamatan kerja pengoperasian derek dan penarikan sling laut.',
    status: 'Released',
    author: 'Capt. Hendra',
  ...
  },
  {
    ...
    judul: 'Kebijakan Mutu, K3LH, dan Zero Harm Mandate PT Taka Hydrocore',
    listDokumen: ['Customer', 'Seluruh Karyawan', 'Auditor'],
    fileName: null,
    fileSize: '',
    catatan: 'Dokumen kebijakan pokok yang ditandatangani oleh Direktur Utama.',
    status: 'Approved',
    author: 'Bambang S.',
  ...
  },
  {
    ...
    dept: 'Geotechnical Operation',
    jenis: 'Standar Operasional Prosedur (SOP)',
    judul: 'Soil Mechanics Triaxial Shear & Consolidation Testing Standard',
    listDokumen: ['Customer'],
    fileName: 'SOP-LAB-001_Triaxial_Testing.pdf',
    fileSize: '2.1 MB',
    catatan: 'Standar kalibrasi sel triaxial dan uji mekanika tanah sampel offshore.',
    status: 'Released',
  ...
  },
  {
    ...
    judul: 'Prosedur Pengendalian Dokumen & Rekaman Terkendali (DCMS)',
    listDokumen: ['Seluruh Karyawan'],
    fileName: 'PRO-DCMS-001_Doc_Control.pdf',
    fileSize: '650 KB',
    catatan: 'Prosedur tata kelola kodifikasi dokumen, revisi berkas, dan masa simpan.',
    status: 'Released',
    author: 'Reza Firmansyah',
  ...
  },
  {
    ...
    dept: 'QHSE',
    jenis: 'Instruksi Kerja (Work Instruction)',
    judul: 'Petunjuk Penggunaan DCMS untuk User dan Department Head',
    listDokumen: ['Seluruh Karyawan'],
    fileName: 'WI-DCMS-002_User_Guide.pdf',
    fileSize: '1.4 MB',
    catatan: 'Panduan step-by-step akses masterlist, submission, dan persetujuan.',
    status: 'Released',
  ...
  },
  {
    ...
    listDokumen: ['Seluruh Karyawan'],
    fileName: 'FRM-HR-003_Induction_Checklist.pdf',
    fileSize: '310 KB',
    catatan: 'Checklist verifikasi sertifikat BST, HUET, dan MCU personil lapangan.',
    status: 'Approved',
    author: 'Dewi Lestari',
  ...
  },
  {
    ...
    jenis: 'Instruksi Kerja (Work Instruction)',
    judul: 'Instruksi Kerja Mobilisasi Vessel & PCPT Seabed Deployment',
    listDokumen: ['Vendor / Kontraktor', 'Customer'],
    fileName: 'WI-OPS-007_PCPT_Mobilization.pdf',
    fileSize: '780 KB',
    catatan: 'Instruksi kerja mobilisasi alat piezocone penetrometer ke kapal survei.',
    status: 'Under Review',
    author: 'Agus Wijaya',
  ...
  },
  {
    ...
    jenis: 'Prosedur (Procedure)',
    judul: 'GA-OFC-01 Perawatan, Pemeliharaan, Dan Perbaikan Sarana Prasarana',
    listDokumen: ['Seluruh Karyawan'],
    fileName: null,
    fileSize: '',
    catatan: 'Prosedur berkala pemeliharaan workshop geoteknik dan kantor pusat.',
    status: 'Approved',
  ...
  },
  {
    ...
    dept: 'Commercial',
    jenis: 'Prosedur (Procedure)',
    judul: 'Client QHSSE Bridging & SIMOPS Coordination Procedure',
    listDokumen: ['Customer', 'Vendor / Kontraktor'],
    fileName: 'PRO-PRJ-004_Bridging_SIMOPS.pdf',
    fileSize: '1.1 MB',
    catatan: 'Tata cara penyelarasan dokumen QHSSE dengan klien sebelum kick-off.',
    status: 'Under Review',
    author: 'Rian Hidayat',
  ...
  },
  {
    ...
    id: 'REG0723.004',
    dept: 'Facility',
    jenis: 'Pedoman (Guideline)',
    judul: 'Downhole Piezocone Penetrometer (PCPT) Calibration Guidelines',
    listDokumen: ['Seluruh Karyawan'],
    fileName: 'GDL-ENG-002_PCPT_Calibration.pdf',
    fileSize: '950 KB',
    catatan: 'Pedoman standar kalibrasi sensor tekanan pori konus sebelum uji laut.',
    status: 'Draft',
    author: 'Eko Prasetyo',
...
export default function RegistrationPage() {
  ...
  const handleSubmitNewDoc = (e: React.FormEvent) => {
    ...
    const currentAuthor = user?.name || (user?.role === 'admin' ? 'Hendra Pratama (Admin Master)' : 'Ahmad Fauzi (Staff)');
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <div style={{ fontSize: '13px', color: '#64748b', marginTop: '2px' }}>
            Alur Manual: Pengajuan berkas baru oleh Staff → Verifikasi &amp; Approval manual oleh Admin Master.
          </div>
        </div>
